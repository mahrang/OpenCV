/*  This program detects faces in an image/video using Haar cascade classifier
 ...
 the alpha value to alpha-blend another face onto the faces detected.  This
 program accepts image and video files as input, but not webcam.
 Inputs supplied were in this order:
 --cascade=/Users/.../My_Code/haarcascade_frontalface_alt.xml
 --scale=1.3
 lena.jpg or faces.png             (this is the photo you want to detect faces in)
 skull.jpg             (this is the face you want to blend onto faces detected) */
