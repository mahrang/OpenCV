/*  This program detects faces and eyes in images, videos, and webcam.
 Inputs supplied were in this order:
 --cascade=/Users/.../My_Code/haarcascade_frontalface_alt.xml
 --nested-cascade=/Users/.../My_Code/haarcascade_eye_tree_eyeglasses.xml
 --scale=1.3
 lena.jpg, bday.jpg, faces.png, or output.mp4  */
...
int main( int argc, const char** argv )
{
    ...
    inputName = parser.get<string>("@filename");  // image or video file
    if (!parser.check())
    {
        parser.printErrors();
        return 0;
    ...
    if( capture.isOpened() )  // if using video file or webcam
    {
    ...
    else
    {
        ...
        if( !image.empty() )  //if you have provided an image file
        {
